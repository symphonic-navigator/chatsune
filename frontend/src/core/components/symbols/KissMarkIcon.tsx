...
/**
 * Kiss-mark glyph — replacement for the 💋 emoji (NSFW indicator).
 * Renders at the surrounding font-size; keeps its native red colours
 * because the colour is part of the semantic (warning / NSFW).
 * Source: svgrepo.com (kiss-mark-svgrepo-com.svg).
 */
export function KissMarkIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
