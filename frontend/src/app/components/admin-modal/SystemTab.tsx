    ...
    return (
      <div className="flex flex-1 items-center justify-center">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[12px] text-white/40">Loading system prompt...</span>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-1 flex-col gap-4 p-4 overflow-hidden">
      ...
      <textarea
        ...
        className="flex-1 min-h-[240px] resize-y rounded-lg border border-white/8 bg-surface p-3 text-[12px] text-white/70 font-mono leading-relaxed placeholder:text-white/20 focus:border-white/15 focus:outline-none transition-colors"
      />
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="rounded-lg border border-white/8 px-4 py-1.5 text-[11px] text-white/55 transition-colors enabled:hover:bg-white/6 enabled:hover:text-white/75 disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer"
          >
            {saving ? "Saving..." : "Save"}
          </button>
        </div>
